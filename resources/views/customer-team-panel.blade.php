<section class="overflow-hidden rounded-3xl border border-violet-100 bg-white shadow-xl shadow-violet-100/50">
    <div class="grid lg:grid-cols-[.8fr_1.2fr]">
        <div class="customer-theme-team-hero relative overflow-hidden p-6 text-white sm:p-8">
            <div class="customer-theme-blur absolute -right-12 -top-12 h-40 w-40 rounded-full bg-fuchsia-400/20 blur-2xl"></div>
            <div class="relative">
                ...
                @if($showReferralCode)
                    <div x-data="{ copied:false }" class="mt-6 rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur">
                        ...
                        <div class="mt-2 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div class="min-w-0">
                                <b class="block break-all font-mono text-lg sm:text-xl">{{ $customer->referral_code }}</b>
        ...
        <div class="customer-theme-team-summary p-6 sm:p-8">
        ...
        <div x-ref="network" :class="fullscreen ? 'h-[calc(100vh-72px)]' : 'min-h-80'" class="customer-theme-team-canvas network-canvas relative overflow-auto p-4">
            <div class="mx-auto flex min-w-max origin-top flex-col items-center pb-5 pt-4" :style="`zoom:${zoom}`">
                ...
                <div class="network-owner group relative z-10 w-72 overflow-hidden rounded-2xl border border-indigo-100 bg-white text-left shadow-xl shadow-indigo-200/70 ring-2 ring-white transition duration-300 hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="customer-theme-team-owner-header relative overflow-hidden bg-gradient-to-r from-slate-950 via-indigo-950 to-violet-900 p-3.5">
