<x-app-layout>
    <x-slot name="header"><h2 class="text-xl font-semibold text-gray-800">Edit {{ $staff->name }}</h2></x-slot>
    <div class="py-8"><div class="mx-auto max-w-3xl px-4">
        ...
        <form method="POST" action="{{ route('staff.update', $staff) }}" class="rounded-xl bg-white p-6 shadow">@include('staff._form')</form>
    </div></div>
</x-app-layout>
